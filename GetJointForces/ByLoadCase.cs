...
#region Members
  ...
  /// </summary>
  private void RunScript(System.Object cSAP, bool Active, List<string> DefineLoadCase, List<string> nodeNumbers, ref object ActiveNode, ref object LoadCases, ref object LC_U1, ref object LC_U2, ref object LC_F2, ref object LC_F3)
  {
  // <Custom code>  
  ...
  // Use ret to check if functions return successfully (ret = 0) or fail (ret = nonzero)
    ...
    for (var j = 0;j < numberOfNodes;j++)
    {
      ...
      for (int k = 0; k < n; k++)
      {
        string loadCase = DefineLoadCase[k];

        ret1 = mySapModel.Results.Setup.DeselectAllCasesAndCombosForOutput();
        ret1 = mySapModel.Results.Setup.SetCaseSelectedForOutput(loadCase);
